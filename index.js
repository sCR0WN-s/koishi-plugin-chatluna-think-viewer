...
const defaultForbidden = [
  ...
  '"analysis"\\s*:',
  '"thought"\\s*:',
  '(?:human_relations|‰∫∫ÈôÖÂÖ≥Á≥ª)\\s*[:=]',
  '(?:memory|ËÆ∞ÂøÜ|ËÆ∞ÂøÜÁÇπ|ÊÄªÁªì)\\s*[:=]',
];

// ‰∏•Ê†º <output><message>... ÁªìÊûÑÔºöÂÖÅËÆ∏ÊñáÊú?/ <at>user_id</at> ÊñáÊú¨ / <sticker>url</sticker>
// Ωˆ‘ –Ì 1~5 Ãı <message>£¨@ ÷ªΩ” ‹¥ø ˝◊÷µƒ user_id
...
const Config = Schema.intersect([
  ...
  Schema.object({
    ...
    guardKeywordMode: Schema.boolean().default(true).description('true \u65f6\u6309\u5173\u952e\u8bcd\u5b50\u4e32\u5339\u914dÔºà\u4e0d\u533a\u5206\u5927\u5c0f\u5199Ôºâ\uff0cfalse \u65f6\u6309\u6b63\u5219\u5339\u914d'),
